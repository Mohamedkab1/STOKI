...
<div class="notification-bell-wrapper" style="position: relative;" id="bellWrapper">
    ...
    ">
        ...
        {{-- Liste des notifications par catégorie --}}
        ...
        <div style="
            ...
            text-align: center;
        ">
            <a href="{{ route('notifications.all') }}" style="
                font-size: 12px;
                font-weight: 700;
...
{{-- Script inline pour la logique des onglets CSS (resté minimaliste pour performances UI imm&diatement)--}}
<script>
