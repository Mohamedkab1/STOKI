...
<nav class="navbar navbar-expand-lg sticky-top" style="background: var(--navbar-bg); border-bottom: 1px solid var(--border-color); backdrop-filter: blur(10px);">
    <div class="container-fluid">
        <!-- Logo / Brand -->
        <a class="navbar-brand" href="<?php echo e(route('dashboard')); ?>" style="color: #ffffff; font-weight: 800; text-decoration: none;">
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>" 
                       href="<?php echo e(route('dashboard')); ?>" style="color: var(--text-secondary); transition: all 0.2s ease;">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>" 
                       href="<?php echo e(route('products.index')); ?>" style="color: var(--text-secondary); transition: all 0.2s ease;">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('stock-movements.*') ? 'active' : ''); ?>" 
                       href="<?php echo e(route('stock-movements.index')); ?>" style="color: var(--text-secondary); transition: all 0.2s ease;">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('categories.*') ? 'active' : ''); ?>" 
                       href="<?php echo e(route('categories.index')); ?>" style="color: var(--text-secondary); transition: all 0.2s ease;">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('invoices.*') ? 'active' : ''); ?>" 
                       href="<?php echo e(route('invoices.index')); ?>" style="color: var(--text-secondary); transition: all 0.2s ease;">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" 
                       ...
                       style="color: var(--text-secondary);">
                        ...
                        <span class="d-none d-lg-inline"><?php echo e(Auth::user()->name ?? 'Compte'); ?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" style="min-width: 200px; background: var(--bg-surface); border-color: var(--border-color);">
                        <li>
                            <span class="dropdown-item-text" style="color: var(--text-muted);">
                                ...
                                <?php echo e(Auth::user()->email ?? 'Email'); ?>

                            </span>
                        </li>
                        <li><hr class="dropdown-divider" style="border-color: var(--border-color);"></li>
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('dashboard')); ?>" style="color: var(--text-primary);">
                        ...
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('stock-movements.index')); ?>" style="color: var(--text-primary);">
...
</script><?php /**PATH C:\Users\pc\OneDrive - OFPPT\Bureau\ALL FOLDERS\PROJETS REALISER\app-GESTION_STOCK\GESTION-STOCK\resources\views\layouts\navigation.blade.php ENDPATH**/ ?>